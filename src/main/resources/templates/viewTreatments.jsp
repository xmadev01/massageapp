...
<head>
    <script type="text/javascript" th:src="@{/js/viewTreatments.js}"></script>
</head>
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong th:text="|${customerName}'s Treatments|"></strong></h3>
                        </div>
                    </div>
                    <div th:insert="fragments/messagediv.html :: messagediv" />
                    <form id="listTreatmentFrm" name="listTreatmentFrm" method="post">
                        <input th:type="hidden" th:id="customerId" th:name="customerId" th:value="${customerId}" />
